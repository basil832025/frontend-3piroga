@php
    ...
    try {
        ...
        // Keep the sidebar available if payparts settings are unavailable.
    }
@endphp
...
@else
    ...
    >
        ...
        <div class="mt-3 grid grid-cols-2 gap-2">
            <button type="button" class="flex min-w-0 cursor-pointer items-center gap-2 rounded-lg bg-white p-2 text-left transition hover:ring-2 hover:ring-[#FF7500]/40 focus:outline-none focus:ring-2 focus:ring-[#FF7500]/40" @click="openBankTerms('monobank')" aria-haspopup="dialog">
            ...
            <button type="button" class="flex min-w-0 cursor-pointer items-center gap-2 rounded-lg bg-white p-2 text-left transition hover:ring-2 hover:ring-[#FF7500]/40 focus:outline-none focus:ring-2 focus:ring-[#FF7500]/40" @click="openBankTerms('privatbank')" aria-haspopup="dialog">
